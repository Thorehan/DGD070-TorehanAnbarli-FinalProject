...
public partial class GameEntity {
    ...
    public void AddBoundary(float newMinX, float newMaxX, float newMinZ, float newMaxZ) {
    ...
    public void ReplaceBoundary(float newMinX, float newMaxX, float newMinZ, float newMaxZ) {
        var index = GameComponentsLookup.Boundary;
        var component = (BoundaryComponent)CreateComponent(index, typeof(BoundaryComponent));
        component.minX = newMinX;
        component.maxX = newMaxX;
