...
public partial class GameEntity {
    ...
    public void AddGameState(bool newİsGameWon, int newActivatedPadsCount) {
        var index = GameComponentsLookup.GameState;
        var component = (GameStateComponent)CreateComponent(index, typeof(GameStateComponent));
        component.isGameWon = newİsGameWon;
        component.activatedPadsCount = newActivatedPadsCount;
        AddComponent(index, component);
    }

    public void ReplaceGameState(bool newİsGameWon, int newActivatedPadsCount) {
        var index = GameComponentsLookup.GameState;
        var component = (GameStateComponent)CreateComponent(index, typeof(GameStateComponent));
        component.isGameWon = newİsGameWon;
        component.activatedPadsCount = newActivatedPadsCount;
